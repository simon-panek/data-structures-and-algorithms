...
const firstLetters = (arr) => {
  let newArray = [];
  arr.forEach(string => {
    newArray.push(string.substring(0,1));
  })
  return newArray;
};
...
const standardizePhoneNumbers = (arr) => {
  ...
  arr.forEach(number => {
    newPhone.push(
      number.charAt(1) + number.charAt(2) + number.charAt(3) + number.charAt(6) + number.charAt(7) + number.charAt(8) + number.charAt(10) + number.charAt(11) + number.charAt(12) + number.charAt(13)
    );
  })
